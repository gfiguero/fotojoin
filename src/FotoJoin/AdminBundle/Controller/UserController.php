...
use FotoJoin\AdminBundle\Form\UserType;
...
class UserController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        return $this->render('FotoJoinAdminBundle:User:index.html.twig', array(
            'users' => $users,
            'direction' => $direction,
            'sort' => $sort,
        ));
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('FotoJoinAdminBundle:User:new.html.twig', array(
    ...
    public function showAction(User $user)
    {
        ...
        return $this->render('FotoJoinAdminBundle:User:show.html.twig', array(
            'user' => $user,
    ...
    public function editAction(Request $request, User $user)
    {
        ...
        return $this->render('FotoJoinAdminBundle:User:edit.html.twig', array(
            'user' => $user,
            'editForm' => $editForm->createView(),
            'deleteForm' => $deleteForm->createView(),
        ));
    ...
    public function deleteAction(Request $request, User $user)
    {
        ...
        return $this->render('FotoJoinAdminBundle:User:delete.html.twig', array(
            'user' => $user,
            'deleteForm' => $deleteForm->createView(),
        ));
    }
