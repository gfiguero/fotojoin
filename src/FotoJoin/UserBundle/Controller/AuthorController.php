...
class AuthorController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        if($sort) $authors = $em->getRepository('FotoJoinUserBundle:Author')->findBy(array(), array($sort => $direction));
        else $authors = $em->getRepository('FotoJoinUserBundle:Author')->findAll();
    ...
    {
        $author = new Author();
        $form = $this->createForm('FotoJoin\UserBundle\Form\AuthorType', $author);
    ...
    {
        $deleteForm = $this->createDeleteForm($author);
        $editForm = $this->createForm('FotoJoin\UserBundle\Form\AuthorType', $author);
